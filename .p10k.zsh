# Generated by Powerlevel10k configuration wizard on 2021-05-13 at 18:28 WIB.
...
() {
  ...
  # DIRECTORY ICON
  #typeset -g POWERLEVEL9K_HOME_ICON='ﳐ'
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|ppp|(.*tun)|tailscale)[0-9]*'
  ...
  #typeset -g POWERLEVEL9K_IP_FOREGROUND=253
  ...
  typeset -g POWERLEVEL9K_IP_INTERFACE='(ccmni0|ccmni1|ap0|[ew].*)'
  # Custom icon.
